...
get_header();
?>
    <main id="primary" class="site-main hall-page custom-template ">
        ...
        <?php include get_template_directory() . '/template-parts/section/description.php'; ?>
        ...
        <?php include get_template_directory() . '/template-parts/section/video.php'; ?>
