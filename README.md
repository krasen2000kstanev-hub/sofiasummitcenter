...
- Проверени са live quote-овете за 1, 2 и 3 участници, трите типа билети, невалиден промокод и всички x2/x3 payment links. Не е правено реално плащане или email delivery тест.
