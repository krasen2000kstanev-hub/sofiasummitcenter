...
VALUES
  ('promo-borislava20','event-nail-business-restart','BORISLAVA20','percent',20,'[]',1,20,25),
  ('promo-elena20','event-nail-business-restart','ELENA20','percent',20,'[]',1,20,25),
  ('promo-ognyan20','event-nail-business-restart','OGNYAN20','percent',20,'[]',1,20,25);
...
FROM promo_codes p WHERE p.code IN ('BORISLAVA20','ELENA20','OGNYAN20')
